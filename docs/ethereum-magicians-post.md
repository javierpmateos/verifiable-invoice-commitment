...
> **Note:** this is the draft body to be posted on
> [ethereum-magicians.org](https://ethereum-magicians.org/) under the *ERCs*
> category once the repository is public and reference deployments are live.
> Replace `[REPO_URL]`, `[PREPRINT_URL]`, and `[DEPLOYMENT_TABLE]`
...
- **Repository:** [REPO_URL]
- **Full draft EIP:** [REPO_URL]/blob/main/eip/eip-vic.md
- **Reference implementation:** [REPO_URL]/tree/main/contracts
- **Preprint with full literature review:** [PREPRINT_URL]
